...
Implements Readable,Writeable
	#tag Method, Flags = &h0
		Sub Close()
		  ...
		  '
		  ' See:
		  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.Close
	...
	#tag Method, Flags = &h0
		Function EOF() As Boolean
		  ...
		  '
		  ' See:
		  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.EOF
	...
	#tag Method, Flags = &h0
		Function Lookahead(encoding As TextEncoding = Nil) As String
		  ...
		  '
		  ' See:
		  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.Lookahead
	...
	#tag Method, Flags = &h0
		 Shared Function Open(InputStream As FolderItem, Encoding As Integer = zlib.Z_DETECT) As zlib.CompressedStream
	...
	#tag Method, Flags = &h0
		 Shared Function Open(InputStream As Readable, Encoding As Integer = zlib.Z_DETECT) As zlib.CompressedStream
	...
	#tag Method, Flags = &h0
		Function Read(Count As Integer, encoding As TextEncoding = Nil) As String
		  ...
		  '
		  ' See:
		  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.Read
	...
	#tag Method, Flags = &h0
		Function ReadAll(encoding As TextEncoding = Nil) As String
		  ...
		  '
		  ' See:
		  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.ReadAll
	...
	#tag Method, Flags = &h0
		Function ReadError() As Boolean
		  ...
		  '
		  ' See:
		  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.ReadError
	...
	#tag Method, Flags = &h0
		Function ReadLine(encoding As TextEncoding = Nil, EOL As String = "") As String
		  ...
		  '
		  ' See:
		  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.ReadLine
	...
	#tag Method, Flags = &h0
		Sub Reset()
		  ' Resets the CompressedStream to its original state.
		  '
		  ' See:
		  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.Reset
	...
	#tag Method, Flags = &h0
		Sub Write(Data As String)
		  ...
		  '
		  ' See:
		  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.Write
	...
	#tag Method, Flags = &h0
		Function WriteError() As Boolean
		  ...
		  '
		  ' See:
		  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.WriteError
	...
	#tag Method, Flags = &h0
		Sub WriteLine(Data As String, EOL As String = "")
		  ...
		  '
		  ' See:
		  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.WriteLine
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ' When False, CompressedStream.Read(Count) will read Count compressed bytes and return zero or
			  ...
			  '
			  ' When True (default), CompressedStream.Read(Count) will return either exactly Count decompressed
			  ' bytes, buffering any leftovers in memory until the next call to CompressedStream.Read(Count);
			  ' or, fewer than Count bytes if there is not enough bytes left to read from the stream.
			  '
			  ' See:
			  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.BufferedReading
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  '
			  ' See:
			  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.Encoding
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  '
			  ' See:
			  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.IsReadable
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  '
			  ' See:
			  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.IsWriteable
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  '
			  ' See:
			  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.LastError
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  '
			  ' See:
			  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.Level
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  '
			  ' See:
			  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.Ratio
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  '
			  ' See:
			  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.Strategy
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  '
			  ' See:
			  ' https://github.com/charonn0/RB-zlib/wiki/zlib.CompressedStream.TotalIn
